...
public class FileLogger:LoggerServiceBase
{
    ...
    public FileLogger(IConfiguration configuration)
    {
        ...
        Logger = new LoggerConfiguration().WriteTo.File(
            ...
            retainedFileCountLimit:null,//limit dolunca eski dosyaları silmek istersek buradan yapabiliriz
            fileSizeLimitBytes:5000000,//dosyanın boyutu maksimum bu kadar olsun
