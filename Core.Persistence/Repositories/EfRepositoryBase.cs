...
namespace Core.Persistence.Repositories
{
...

    {
        ...
        {
            //queryFilter araştıralacak
            //globalfilter araştıralacak
        ...
        public async Task<TEntity?> GetAsync(Expression<Func<TEntity, bool>> predicate, Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>? include = null, bool withDeleted = false, bool eanbleTracking = true, CancellationToken cancellationToken = default)
        {
            IQueryable<TEntity> queryable = Query();
            if (!eanbleTracking)
                queryable = queryable.AsNoTracking();
